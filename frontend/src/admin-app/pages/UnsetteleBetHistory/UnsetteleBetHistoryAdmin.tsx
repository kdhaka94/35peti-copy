...
//   // 🔥 UI ONLY FILTER
//   const [betOnFilter, setBetOnFilter] = React.useState<'SPORT' | 'CASINO'>('SPORT')
...
//   // 🔥 ORIGINAL FILTER DATA (UNCHANGED)
//   const [filterdata, setfilterdata] = React.useState<any>({
//     status: 'pending',
//     type: params.type,
//     matchId,
...
//   // ================= FETCH =================
//   React.useEffect(() => {
//     const obj: any = { ...filterdata }

//     if (!matchId) {
//       obj.startDate = moment().subtract(7, 'days').format('YYYY-MM-DD')
...
//   React.useEffect(() => {
//     setfilterdata((prev: any) => ({ ...prev, type: params.type }))
//     getbethistory(1)
//   }, [params.type])
...
//   // ================= 🔥 UI LEVEL CASINO / SPORT FILTER =================
//   const filteredDocs = React.useMemo(() => {
//     if (!bethistory?.docs) return []

//     if (betOnFilter === 'CASINO') {
//       return bethistory.docs.filter((b: any) => b.bet_on === 'CASINO')
//     }

//     // SPORT = jo casino nahi
//     return bethistory.docs.filter((b: any) => b.bet_on !== 'CASINO')
//   }, [bethistory, betOnFilter])

//   // ================= HANDLERS =================
//   const onSuggestionsFetchRequested = ({ value }: any) =>
//     userService.getUserListSuggestion({ username: value })
...
//     getbethistory(e.selected + 1)

//   // ================= DELETE =================
//   const onTrash = (e: MouseEvent<HTMLAnchorElement>, bet: IBet) => {
//     e.preventDefault()
//     if (!bet._id) return toast.error('Invalid bet')
...
//             ...prev,
//             docs: prev.docs.filter((b: IBet) => b._id !== bet._id),
//           }))
//         }
//       })
//     }
...
//     setbethistory((prev: any) => ({
//       ...prev,
//       docs: prev.docs.map((b: any) => {
//         const isCasino = b.bet_on === 'CASINO'
//         if (
//           (betOnFilter === 'CASINO' && isCasino) ||
//           (betOnFilter === 'SPORT' && !isCasino)
//         ) {
//           return { ...b, selected: !selectAll }
//         }
//         return b
//       }),
//     }))
...
//       ...prev,
//       docs: prev.docs.map((b: any) =>
//         b._id === item._id ? { ...b, selected: !b.selected } : b,
//       ),
//     }))
//   }
...
//   // ================= BULK DELETE =================
//   const deleteBulk = () => {
//     const ids = bethistory.docs
//       ?.filter((b: any) => b.selected)
//       .map((b: any) => b._id)

//     if (!ids?.length) return toast.error('Please select one item')

//     betService.deleteBets({ ids }).then((res) => {
//       if (res.data.data.success) {
//         toast.success(res.data.message)
//         setbethistory((prev: any) => ({
//           ...prev,
//           docs: prev.docs.filter((b: any) => !b.selected),
//         }))
//         setSelectAll(false)
//       }
//     })
...
//                 <input
//                   type="radio"
//                   checked={betOnFilter === 'SPORT'}
//                   onChange={() => setBetOnFilter('SPORT')}
//                 /> Sports
//               </label>
...
//                 <input
//                   type="radio"
//                   checked={betOnFilter === 'CASINO'}
//                   onChange={() => setBetOnFilter('CASINO')}
//                 /> Casino
//               </label>
//             </div>
//           </div>
...
//             <div className="card-body">
//               <BetListComponent
//                 bethistory={{ ...bethistory, docs: filteredDocs }}
//                 handlePageClick={handlePageClick}
//                 onTrash={onTrash}
//                 page={page}
//                 isTrash
...
const UnsetteleBetHistoryAdmin = ({ hideHeader, matchId }: any) => {
  ...
  // ================= UI CASINO / SPORT FILTER =================
  const filteredDocs = React.useMemo(() => {
    if (!bethistory?.docs) return []
    return bethistory.docs.filter((b: any) =>
      betOnFilter === 'CASINO'
        ? b.bet_on === 'CASINO'
        : b.bet_on !== 'CASINO',
    )
