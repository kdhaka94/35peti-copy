...
const ProfitLossAdmin = () => {
  ...
  return (
    <>
      {mobileSubheader.subheaderdesktopadmin('Profit/Loss')}
          ...
          <div className={!isMobile ? 'col-md-12 mt-1' : 'col-md-12 padding-custom'}>
            <div className=''>
              ...
              <div className='card-body'>
                <div className='profitloss-box row ' style={{ marginLeft: "0px", marginRight: "0px" }}>
                  {Object.keys(pnlboxFinal).map((Item: any, key: any) => {
                    return <div key={key} className={pnlboxFinal[Item] >= 0 ? 'bg-green col15' : 'bg-red col15'}>
                      {Item} : {pnlboxFinal[Item]}
                    </div>
                  })}
