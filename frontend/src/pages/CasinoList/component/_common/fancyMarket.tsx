...
//     const oddVal = parseFloat(isBack ? item.odds[0].odds: item.odds[1].odds)
//     const ssid = isBack ? item.odds[0].sid: item.odds[1].sid
...
//             volume: parseFloat(isBack ? item.odds[0].size : item.odds[1].size),
//             marketId: item.mid,
//             marketName: oddsMarket.MarketName,
//             matchId: parseInt(lastOdds?.match_id || 0),
//             selectionName: item.nat,
//             selectionId: item.ssid,
//             pnl: 0,
//             stack: 0,
//             currentMarketOdds: isBack ? item.odds[0].odds : item.odds[1].odds,
//             eventId: item.mid,
//             exposure: -0,
//             ipAddress: ipAddress,
//             type: IBetType.Match,
...
//         const gstatus =
//           ItemRunner.gstatus == 'SUSPENDED' || ItemRunner.status == 'CLOSED' ? 'suspended' : ''
//         return (
...
//                   }}
//                 >
//                   <span className='odd d-block'> {ItemRunner.odds[1].odds}</span>
//                   <span>{ItemRunner.odds[1].size}</span>
//                 </div>
//                 <div
...
//                   }}
//                 >
//                   <span className='odd d-block'> {ItemRunner.odds[0].odds}</span>
//                   <span>{ItemRunner.odds[0].size}</span>
//                 </div>
