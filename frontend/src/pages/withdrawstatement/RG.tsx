    ...
    <div className="container my-5">
      <div className="card shadow-lg border-0 rounded-4 p-4">
        ...
        <p className="text-muted text-center mb-5">
          At <strong>{window.location.hostname.replace('www.', '')}</strong>, we encourage all users to enjoy
        ...
        <section className="mb-4">
          ...
          <p>
            <strong>{window.location.hostname.replace('www.', '').split('.')[0]}</strong> stands for safe, transparent, and enjoyable
        ...
        <p className="text-center mt-5 small text-secondary">
          © {new Date().getFullYear()} {window.location.hostname.replace('www.', '')} — Play Responsibly.
        </p>
      </div>
    </div>
  );
